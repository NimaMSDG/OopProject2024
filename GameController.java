...
public class GameController {
    ...
    public void playcard1(String r,String a,boolean b,int maxround,int type){
        Matcher m=GameController.getmatcher(r,a);
    ...
    void printtable(){
        ...
        for(int i=0;i<21;i++){
            if(plateuse[2][i]>0){
                if (plate[2][i].segmentDamage()>9) System.out.print(plate[2][i].segmentDamage()+" | ");
                else System.out.print(plate[2][i].segmentDamage()+"  | ");}
            else if(plateuse[2][i]==0){
                System.out.print("   | ");
            }
            else if(plateuse[2][i]==-1){
